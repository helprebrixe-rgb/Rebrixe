...
const categories = {
        ...
        "time-date": ["12 to 24 Hour Converter","24 to 12 Hour Converter","Academic Year Calculator","Add Subtract Days","Age at Date Calculator","Age Calculator","Bi Weekly Pay Calculator","Billable Hours Tracker","Break Reminder Timer","Break Time Calculator","Bulk Date Format Converter","Business Days Calculator","Call Scheduler Across Time Zones","Chess Clock and Debate Timer","Class Schedule Builder","Content Calendar Generator","Contractor Day Rate Calculator","Current Time in Any City","Daily Hours Logger","Daily Routine Builder","Date Difference Breakdown","Date Format Converter","Day of Week Finder","Days Between Dates Calculator","Days in Month Calculator","Days Since Calculator","Days Until Calculator",
